const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=5a69da6bedb5c53762ac5a1761526a1b";
fetch(apiURL)
...
const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=5a69da6bedb5c53762ac5a1761526a1b";
fetch(forecastURL)
  .then((response) => response.json())
  .then((jsObject) => {
